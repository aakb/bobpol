...
namespace Drupal\bobpol_hotness\Form;
 ...
 * Configuration form for the bobpol hotness module.
 */
class BobpolHotnessConfigForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'bobpol_hotness_admin_settings';
  }
  ...
  private function getSettings() {
    return \Drupal::getContainer()->get('bobpol_hotness.settings');
  }
